...
class MenuGUI():
    ...
    def _only_tshirt_show(self):
        ...
        Label(self.mainarea_tshirt, text="Price").pack()

        self.entry_mainarea_tshirt = Entry(self.mainarea_tshirt, textvariable=self._priceVar, width=15)

        self.entry_mainarea_tshirt.pack()

        Button(self.mainarea_tshirt, text="Sell", width=15, command=self._enter_data).pack()
    ...
    def _only_posters_show(self):
        ...
        Label(self.mainarea_posters, text="Price").pack()

        self.entry_mainarea_posters = Entry(self.mainarea_posters, textvariable=self._priceVar, width=15)

        self.entry_mainarea_posters.pack()

        Button(self.mainarea_posters, text="Sell", width=15, command=self._enter_data).pack()
    ...
    def _only_boot_show(self):
        ...
        self.mainarea_boots = tk.Frame(self.root, bg=self.mainarea_bg_color, width=self.main_area_width,
        ...
        Label(self.mainarea_boots, text="Price").pack()

        self.entry_mainarea_boots = Entry(self.mainarea_boots, textvariable=self._priceVar, width=15)
    ...
    def _show_all_items(self):
        ...
        self.mainarea_show_all_items = tk.Frame(self.root, bg=self.mainarea_bg_color, width=self.main_area_width,
                                                height=self.window_height)
    ...
    def _enter_data(self):
        ...
        priceVar = self._priceVar.get()
        db = sqlite3.connect("database_filename")
        cursor = db.cursor()
        cursor.execute('insert into %s (name,price) values (?,?)' % (self._tablename), (storeVar, priceVar))
        db.commit()
